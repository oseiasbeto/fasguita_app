  ...
  <div class="min-h-screen bg-white flex flex-col">
    ...
    <div class="flex-1 flex flex-col justify-center px-6 pb-12">
      <div class="w-full">
        ...
        <form @submit.prevent="handleRegister" class="space-y-8" autocomplete="off">
          <!-- Nome Completo -->
          <div>
            ...
            <div class="relative">
              ...
              <div class="absolute inset-y-0 right-5 flex items-center">
                <svg v-if="fullNameValid && fullNameTouched" class="w-7 h-7 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                </svg>
                <svg v-if="fullNameTouched && !fullNameValid" class="w-7 h-7 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
          ...
          <div>
            ...
            <div class="relative">
              ...
              >
                <svg v-if="showPassword" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <button
                ...
                class="absolute inset-y-0 right-5 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none"
              >
                <svg v-if="showConfirmPassword" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                </svg>
                <svg v-else class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <p v-if="confirmPassword.length > 0 && confirmPassword !== password" class="mt-2 text-sm text-red-600 font-medium">
...
const handleRegister = async () => {
  ...
  const success = await store.dispatch('register', {
    ...
    // Aqui podes enviar também o fullName.value se quiseres guardar no backend
  })
